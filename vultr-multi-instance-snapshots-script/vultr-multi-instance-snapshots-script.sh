#!/bin/sh
set -e
# This version of the script retrieves all Vultr instances associated with your account and creates snapshots for each of them. By using this method, you keep your sensitive information separate from the script, making it easier to manage and more secure. Remember to add .env to your .gitignore file if you're using version control to prevent accidentally committing sensitive information.
